report 50023 "Billing Note 3"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.src/ReportLaout/BillingNote3.rdlc';
    PreviewMode = Normal;
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            dataitem("Sales Billing Header"; "Sales Billing Header")
            {
                ...
                column(Dept; salesperson.Dept) { }
                column(Email; salesperson."E-Mail") { }
                column(Tel; salesperson."Phone No.") { }
                dataitem("Sales Billing Line"; "Sales Billing Line")
                {
                    ...
                    column(WHT3; WHT3) { }
                    column(WHT5; WHT5) { }
                    column(SumTotalA; SumTotalA) { }
                    column(SumTotalB; SumTotalB) { }
                    ...
                    begin
                        ...
                        if "Sale Invoice No." <> '' then
                            rows += 1;
                        SumTotalA := ("Cust. Original Amount (LCY)" + "Cust. VAT Amount");
                        SumTotalB := ("Sales Billing Line"."Cust. Original Amount (LCY)" + "Sales Billing Line"."Cust. VAT Amount") - ("Sales Billing Line".WHT + "Sales Billing Line".WHT3 + "Sales Billing Line".WHT5);
                    end;
                }
                ...
                begin
                    ...
                    if "Bill-to Customer No." <> '' then begin
                        ...
                        if CustomerS.Find('-') then begin
                            TelFax := 'โทร ' + CustomerS."Phone No." + ' แฟกซ์ ' + CustomerS."Fax No.";
                        end;
                    end;
                    BillingL.Reset();
                    ...
                    if "Issue By" <> '' then begin
                        ...
                        if salesperson.Find('-') then begin
                            IssueByText := salesperson."Full Name Thai";
                            if IssueByText = '' then
