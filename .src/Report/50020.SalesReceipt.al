report 50020 "Sales Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.src/ReportLaout/SalesReceipt.rdlc';
    PreviewMode = Normal;
    dataset
    {
        dataitem("Sales Billing Header"; "Sales Billing Header")
        {
            ...
            DataItemTableView = where("Document Type" = filter('Sales Receipt'));
            column(No_; "No.") { }
            ...
            column(TotalAmountTextTH; TotalAmountTextTH) { }
            ...
            begin
                ...
                BillingL.SetRange("Document Type", BillingL."Document Type"::"Sales Receipt");
                ...
                if TotalAmount > 0 then begin
                    ...
                    TotalAmountTextTH := utility.FormatNoThaiText(TotalAmount);
                end;
                salesperson.Reset();
