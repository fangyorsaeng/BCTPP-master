table 50024 "Transfer Production Line"
{
    fields
    {
        ...
        field(4; "Part No."; Code[20])
        {
            ...
            trigger OnValidate()
            var
                TempL: Record "Transfer Production Line";
                CRow: Integer;
                ItemS: Record Item;
            begin
        ...
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Invt. Receipt Line"."Document No." where("Item No." = field("Part No."), "MDLH No." = field("Document No."), "MDLH Line No." = field("Line No.")));
        }
        field(21; "Receipt Line"; Integer)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Invt. Receipt Line"."Line No." where("Item No." = field("Part No."), "MDLH No." = field("Document No."), "MDLH Line No." = field("Line No.")));
        }
