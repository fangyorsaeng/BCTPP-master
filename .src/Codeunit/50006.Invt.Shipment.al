codeunit 50006 "Invt. Doc.-Post Shipment XTH"
{
        ...
        with InvtDocHeader do begin
            ...
            if InvtDocLine.Find('-') then
                repeat
                    ...
                    //XTH//
                    InvtShptLine."Remark Line" := InvtDocLine."Remark Line";
                    InvtShptLine."MDLH Line No." := InvtDocLine."MDLH Line No.";
                    InvtShptLine."MDLH No." := InvtDocLine."MDLH No.";
                    InvtShptLine."Reason Code" := InvtDocLine."Reason Code";
                    InvtShptLine.Customer := InvtDocHeader.Customer;
                    //XTH//
    ...
    begin
        ...
        //XTH-TOO+
        ItemJnlLine."Return Reason Code" := InvtShptLine2."Reason Code";
        ItemJnlLine."Reason Code" := InvtShptLine2."Reason Code";
        ItemJnlLine.Customer := InvtShptLine2.Customer;
        //XTH-TOO-
